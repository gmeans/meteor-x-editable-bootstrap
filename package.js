...
Package.on_use(function (api){
	...
	api.add_files('lib/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.2/wysiwyg-color.css', 'client');
	api.add_files('lib/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.2/wysihtml5-0.3.0.js', 'client', {bare:true});
	api.add_files('lib/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.2/bootstrap-wysihtml5-0.0.2.css', 'client');
	api.add_files('lib/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.2/bootstrap-wysihtml5-0.0.2.js', 'client', {bare:true});
	
	//override image paths
	api.add_files('path-override3.css', 'client');  
});
